...
const IMGLABEL_URL = "http://online{s}.map.bdimg.com/tile/?qt=tile&x={x}&y={y}&z={z}&styles=sl&v=020";

const CUSTOM_URL = "http://api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&customid={style}";

class BaiduImageryProvider {
	constructor(options = {}) {
		this._url = options.style === "img" ? IMG_URL : options.style === "imgLabel" ? IMGLABEL_URL : CUSTOM_URL;
		this._tileWidth = 256;
